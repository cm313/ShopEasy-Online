...
<div class="added-to-cart-message js-added-to-cart-message js-product-add-confirmation-${product.id}" data-testid="added-to-cart-message">
...
//document.querySelectorAll returns a list [] of elements of mentioned class or id or tag etc.
